    ...
    public void testConvert() throws IOException {
        TestPattern[] patterns = new TestPattern[] {
                new TestPattern(60, 60, "jpeg",
                        "/upload/peacock.png", "/upload/peacock_60x60.jpg"),
                new TestPattern(120, null, "jpeg",
                        "/upload/peacock.png", "/upload/peacock_120x.jpg"),
                new TestPattern(null, 60, "jpeg",
                        "/upload/peacock.png", "/upload/peacock_x60.jpg")
        };
