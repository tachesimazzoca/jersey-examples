...
public class StorageSession {
    ...
    public StorageSession(Storage<Map<String, Object>> storage, NewCookie cookie) {
        this(storage, cookie, null);
    }

    public StorageSession(Storage<Map<String, Object>> storage, NewCookie cookie, String sessionId) {
